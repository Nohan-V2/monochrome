...
// .wrangler/tmp/bundle-c9PDqd/checked-fetch.js
...
// .wrangler/tmp/pages-n7vGYH/functionsWorker-0.02525270312858585.mjs
...
__name2(handleCORSPreflight, "handleCORSPreflight");
...
var TidalAPI = class _TidalAPI {
  static {
    __name(this, "_TidalAPI");
  }
  static {
    __name2(this, "TidalAPI");
  }
...
var ServerAPI = class {
  ...
  async getInstances() {
    ...
    let data = null;
    const urls22 = [...this.INSTANCES_URLS].sort(() => Math.random() - 0.5);
...
var _isBlockedCopyright = /* @__PURE__ */ __name2((c) => {
...
var TidalAPI2 = class _TidalAPI2 {
  static {
    __name(this, "_TidalAPI");
  }
  static {
  ...
  async getToken() {
    const params = new URLSearchParams({
      client_id: _TidalAPI2.CLIENT_ID,
      client_secret: _TidalAPI2.CLIENT_SECRET,
      grant_type: "client_credentials"
    });
    const res = await fetch("https://auth.tidal.com/v1/oauth2/token", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Basic " + btoa(`${_TidalAPI2.CLIENT_ID}:${_TidalAPI2.CLIENT_SECRET}`)
      },
      body: params
    });
    if (!res.ok) throw new Error(`Token request failed: ${res.status}`);
...
var TidalAPI3 = class _TidalAPI3 {
  static {
    __name(this, "_TidalAPI");
  }
  static {
  ...
  async getToken() {
    const params = new URLSearchParams({
      client_id: _TidalAPI3.CLIENT_ID,
      client_secret: _TidalAPI3.CLIENT_SECRET,
      grant_type: "client_credentials"
    });
    const res = await fetch("https://auth.tidal.com/v1/oauth2/token", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Basic " + btoa(`${_TidalAPI3.CLIENT_ID}:${_TidalAPI3.CLIENT_SECRET}`)
      },
      body: params
    });
    if (!res.ok) throw new Error(`Token request failed: ${res.status}`);
...
__name2(getTrackTitle, "getTrackTitle");
...
__name2(getTrackArtists, "getTrackArtists");
var TidalAPI4 = class _TidalAPI4 {
  static {
    __name(this, "_TidalAPI");
  }
  static {
  ...
  async getToken() {
    const params = new URLSearchParams({
      client_id: _TidalAPI4.CLIENT_ID,
      client_secret: _TidalAPI4.CLIENT_SECRET,
      grant_type: "client_credentials"
    });
    const res = await fetch("https://auth.tidal.com/v1/oauth2/token", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Basic " + btoa(`${_TidalAPI4.CLIENT_ID}:${_TidalAPI4.CLIENT_SECRET}`)
      },
      body: params
    });
    if (!res.ok) throw new Error(`Token request failed: ${res.status}`);
...
var _isBlockedCopyright2 = /* @__PURE__ */ __name2((c) => {
  const text = typeof c === "string" ? c : c?.text;
...
__name2(loadArtistsData, "loadArtistsData");
...
__name2(fetchTrackerData, "fetchTrackerData");
...
__name2(getAuthHeaders, "getAuthHeaders");
...
__name(getSheetId2, "getSheetId2");
__name2(getSheetId2, "getSheetId");
function normalizeArtistName(name) {
  return name.toLowerCase().replace(/[^a-z0-9]/g, "");
}
__name(normalizeArtistName, "normalizeArtistName");
__name2(normalizeArtistName, "normalizeArtistName");
...
__name(loadArtistsData2, "loadArtistsData2");
__name2(loadArtistsData2, "loadArtistsData");
...
__name2(safeParseTracks, "safeParseTracks");
...
__name2(calculatePlaylistDuration, "calculatePlaylistDuration");
...
// .wrangler/tmp/bundle-c9PDqd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c9PDqd/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.02525270312858585.js.map
